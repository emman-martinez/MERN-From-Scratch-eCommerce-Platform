...
import playstationImage from "../assets/products/playstation.jpg";
import mouseImage from "../assets/products/mouse.jpg";
import alexaImage from "../assets/products/alexa.jpg";
